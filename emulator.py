...
# Updated for Python 3 by Renze Nicolai 2024
...
#            self.ser.setRTS(True)
    ...
    def handleRequest(self, blocking = True):
        ...
        inc = self.readchar()
        if self.FDCmode:
            self.handleFDCmodeRequest(inc.decode("ascii"))
        else:
